...
for i in range(100):
    ...
    metrics['SVM']['precision'].append(precision_score(y_test, y_pred_svm))
    metrics['SVM']['f1'].append(f1_score(y_test, y_pred_svm))
    metrics['SVM']['recall'].append(recall_score(y_test, y_pred_svm))
    metrics['SVM']['roc_auc'].append(roc_auc_score(y_test, y_prob_svm))
    metrics['SVM']['conf_matrix'].append(confusion_matrix(y_test, y_pred_svm))
    metrics['SVM']['classification_report'].append(classification_report(y_test, y_pred_svm, output_dict=True))
    ...
    metrics['Naive Bayes']['accuracy'].append(accuracy_score(y_test, y_pred_nb))
    metrics['Naive Bayes']['precision'].append(precision_score(y_test, y_pred_nb))
    metrics['Naive Bayes']['f1'].append(f1_score(y_test, y_pred_nb))
    metrics['Naive Bayes']['recall'].append(recall_score(y_test, y_pred_nb))
    metrics['Naive Bayes']['roc_auc'].append(roc_auc_score(y_test, y_prob_nb))
    metrics['Naive Bayes']['conf_matrix'].append(confusion_matrix(y_test, y_pred_nb))
    metrics['Naive Bayes']['classification_report'].append(classification_report(y_test, y_pred_nb, output_dict=True))
